...
TEXT,
    ...
    /*
     ...
     |--------------------------------------------------------------------------
     |
     | Ключ — стабильный код источника (хранится в data_sources шаблона).
     | Значение — подпись для админки / UI.
     |
     */
    'data_sources' => [
    ...
    /*
     * Ключи funnel_field_labels, относящиеся к рекламе (а не к воронке).
     * Используются при фильтрации справочника полей для промпта.
     */
    'ads_field_keys' => [
        'clicks',
        'views',
        ...
        'orders',
        'orders_gap',
        'orders_ratio_ads_to_funnel',
    ],

    /*
     * Ключи funnel_field_labels, относящиеся только к сравнению ads vs funnel.
     * Включаются в инструкции только если выбраны оба источника: ads + funnel.
     */
    'ads_vs_funnel_field_keys' => [
        'orders_gap',
        'orders_ratio_ads_to_funnel',
    ],
];
