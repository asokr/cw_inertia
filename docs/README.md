...
Ozon использует **единый** кабинет (`oz_cabinets`) — см. [oz-cabinets.md](oz-cabinets.md). Workspace: `/panel/oz/price-calc`, `/panel/oz/ai-cabinet-analyzer`, `/panel/oz/ab-testing`, `/panel/oz/stock-history`.
