...
const BASE_SETTINGS_FIELDS = [
    ...
    },
    {
        ...
        description:
            "Сколько показов набрать на одном варианте фото, прежде чем сменить главное изображение.",
        unit: "за круг",
        min: 100,
        max: 50000000,
    },
    {
        ...
        description:
            "Минимальное время удержания варианта, даже если показы набрались раньше.",
        unit: "мин",
        min: 5,
        max: 1440,
    },
