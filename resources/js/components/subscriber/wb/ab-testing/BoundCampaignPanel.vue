...
/** Delete blocked while experiment is running (backend also guards). */
const canDelete = computed(
    () => !!advertId.value && !isRunning.value && canEdit.value,
);
        ...
        <div class="flex flex-wrap items-start justify-between gap-3">
            <div class="flex min-w-0 items-start gap-3">
                ...
                <div class="min-w-0">
                    ...
                    >
                        Пока эксперимент запущен, пауза и удаление кампании недоступны — остановите
                        эксперимент на шаге 5.
                    </p>
                </div>
            </div>
