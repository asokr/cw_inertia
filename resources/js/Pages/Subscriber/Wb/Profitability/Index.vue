...
function submitAdd() {
    addForm.post("/panel/wb/profitability/cabinets", {
        preserveScroll: true,
        onSuccess: () => {
            addOpen.value = false;
            addForm.reset();
...
function submitEdit() {
    editForm.put(`/panel/wb/profitability/cabinets/${selectedCabinet.value.id}`, {
        preserveScroll: true,
        onSuccess: () => {
...
function confirmDelete() {
    router.delete(`/panel/wb/profitability/cabinets/${selectedCabinet.value.id}`, {
        preserveScroll: true,
        onSuccess: () => {
...
<template>
    <Head title="Рентабельность Wildberries" />

    <SubscriberLayout title="Рентабельность Wildberries" :breadcrumbs="breadcrumbs">
        <ToolPageHeader title="Рентабельность Wildberries">
            <template #actions>
