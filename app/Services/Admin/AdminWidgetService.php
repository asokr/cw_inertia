...
{
    public function lastSubscriptions(int $rows, string $sortField = 'renewed_at', string $sortOrder = '-1'): array
    {
    ...
    public function lastRegistered(int $rows = 10, int $page = 1): LengthAwarePaginator
    {
