...
class OzAiCabinetAnalyzerPdfGenerator
{
    public function generate(OzAiCabinetAnalyzerAiAnalysis $analysis): string
    {
    ...
    private function buildBodyHtml(OzAiCabinetAnalyzerAiAnalysis $analysis): string
    {
    ...
    private function buildDocumentTitle(OzAiCabinetAnalyzerAiAnalysis $analysis): string
    {
