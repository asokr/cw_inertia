...
final class OzonPriceCalcColumns
{
    ...
    public static function fbo(): array
    {
        return [
            ...
            self::col('logistics_fbo', 'Средний тариф по кластерам (руб)', 'руб', 'рассчёт', '#FFD966', null, ['логистика', 'логистика (руб)', 'логистика fbo']),
            self::col('logistics_fbo_over_190', 'Средний тариф с учетом % выкупа', 'руб', 'рассчёт', '#FFD966', null, ['логистика с учетом выкупа', 'логистика+обратная логистика fbo', 'логистика+обратная логистика']),
    ...
    public static function fbs(): array
    {
        return [
            ...
            self::col('volume_liters', 'Объем (л)', 'л', 'рассчёт', '#FFF2CC', null, ['объем', 'объем (л)']),
            self::col('buyout_percent', '% выкупа', '%', 'заполняется', '#FFF2CC', null, ['% выкупа']),
            self::col('logistics_fbs', 'Средний тариф', 'руб', 'рассчёт', '#FFD966', null, ['логистика', 'логистика (руб)', 'логистика fbs']),
            self::col('logistics_fbs_over_190', 'Средний тариф с учетом % выкупа', 'руб', 'рассчёт', '#FFD966', null, ['логистика с учетом выкупа', 'логистика+обратная логистика fbs']),
            self::col('tax_percent', 'налог', '%', 'заполняется', '#DCE6F1', null, ['налог %']),
